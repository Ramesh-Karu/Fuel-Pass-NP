...
export const ExpenseForm: React.FC<{ user: User; onClose: () => void }> = ({ user, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button type="submit" className="w-full bg-black text-white p-2 rounded">Record Expense</button>
    </form>
  );
};
